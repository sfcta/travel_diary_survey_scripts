...
def taz_spatial_join(config):
    ...
    hh_taz_join = hh_taz_join.rename(
        columns={"home_taz": "hhtaz", "home_maz": "hhparcel"}
    )
    person_taz_join = person_taz_join.rename(
        columns={
            "work_taz": "pwtaz",
            "work_maz": "pwpcl",
            "school_taz": "pstaz",
    ...
    trip_taz_join = trip_taz_join.rename(
        columns={"o_taz": "otaz", "o_maz": "opcl", "d_taz": "dtaz", "d_maz": "dpcl"}
    )
