...
trip = pd.read_csv(r'..\..\MTC-SFCTA2018\Processing_20200228\1_reformat_survey\temp_tripx.dat', sep=' ')
...
print(len(trip))
trip.to_csv(r'..\..\MTC-SFCTA2018\Processing_20200228\1_reformat_survey\temp_tripx_linked_detail_week.csv', index=False)
...
trip.to_csv(r'..\..\MTC-SFCTA2018\Processing_20200228\1_reformat_survey\temp_tripx_linked_week.dat', sep=' ', index=False)

accegr_df.to_csv(r'..\..\MTC-SFCTA2018\Processing_20200228\1_reformat_survey\accegr_week.csv', index=False)
